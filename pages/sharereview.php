...
$i1_int = filter_input(INPUT_GET, 'i1', FILTER_VALIDATE_INT);
if ($i1_int !== false && $i1_int !== null) {
    $i1 = $i1_int;
} else {

  
    $i1_str = filter_input(INPUT_GET, 'i1', FILTER_SANITIZE_SPECIAL_CHARS);
    if ($i1_str !== null && $i1_str !== '') {
        $i1 = trim($i1_str);
    }
}
